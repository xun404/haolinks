					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>尊敬的翡翠贷用户，以下是您在翡翠贷的竞标中投资。
							</h1>
							<p>
						...
						<form>
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<c:forEach items="${loanrecordlist}" var="loanrecord">
									<tr>
										<td><a href="javascript:;">${loanrecord.loanNumber}</a></td>
										<td>${loanrecord.loanTitle}</td>
										<td>${loanrecord.borrowername}</td>
										<td>￥<fmt:formatNumber value="${loanrecord.issueLoan}" pattern="0.00"/></td>
										<td>￥<fmt:formatNumber value="${loanrecord.tenderMoney}" pattern="0.00"/></td>
										<td>${loanrecord.lastDays }(天)</td>
