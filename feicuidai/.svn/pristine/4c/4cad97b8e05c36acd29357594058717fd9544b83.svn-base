    ...
    $.fn.circliful = function(options) {
        var settings = $.extend({
         ...
         return this.each(function() {
                ...
                if($(this).data('text') != undefined) {
                    ...
                    if($(this).data('icon') != undefined) {
                     ...
                     if($(this).data('type') != undefined) {
                        ...
                        $(this).append('<span class="circle-text" style="position: relative;top:-3px;left:5px">' + icon + text + '</span>');
                        $(this).find('.circle-text').css(
                            {'line-height': dimension + 'px', 'font-size' : size + 'px' }
                        );
                    }
              ...
              var canvas = $('<canvas style="position: relative;top:-58px;left:0px"></canvas>').attr({ width: dimension, height: dimension }).appendTo($(this)).get(0);
