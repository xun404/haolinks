...
<!--内容 Start-->
    <div class="amount_head_box">
        ...
        <div class="amount_left">最近10笔提现记录!</div>
    ...
    <c:forEach var="myRechange" items="${expenses}">
        <div class="recharge_records_box">
            ...
            <div class="list_recharge records_center">提现：
                <fmt:formatNumber value="${myRechange[1]}" pattern="0"/>
            </div>
            <div class="list_recharge records_right">余额：
                <fmt:formatNumber value="${myRechange[2]}" pattern="0"/>
            </div>
            <div class="c"></div>
