    ...
    $.fn.circliful = function(options) {
        var settings = $.extend({
         ...
         return this.each(function() {
                ...
                showValue = settings.showValue; //赋值ֵ
                ...
                if($(this).data('text') != undefined) {
                    ...
                    if($(this).data('icon') != undefined) {
                     ...
                     if($(this).data('type') != undefined) {
                        ...
                        $(this).append('<span class="circle-text" style="position: relative;top: -11px;left:48px">' + icon + text + '</span>');
                        $(this).find('.circle-text').css(
                            {'line-height': dimension + 'px', 'font-size' : size + 'px' }
                        );
                    }
              ...
              var canvas = $('<canvas style="position: relative;top: -67px;left: 34px"></canvas>').attr({ width: dimension, height: dimension }).appendTo($(this)).get(0);
              ...
              function animate(current) {
                ...
                context.lineWidth = width-7;    //设置圆圈的宽度
                // line color
