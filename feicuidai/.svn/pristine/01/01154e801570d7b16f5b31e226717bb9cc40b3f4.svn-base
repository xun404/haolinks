...
<style type="text/css">
	...
	.pag_s_1{ background:url(/resources/images/page_r.png) repeat-x;background-color:#00bc00;  padding:0px 7px; border-bottom:1px solid #00bc00; border-left:1px solid #00bc00; border-right:1px solid #00bc00; border-top:1px solid #00bc00; color:#fff; font-weight:bold; }
</style>
