        ...
        <!--vipHeadLeft-->
          <div class="vipHeadLeft">
            ...
            <div class="datainfo">
              ...
              <div style="color:#666666;padding-top:10px;">上次登录：地点${loginLog.address }/时间${fn:substring(loginLog.loginTime,0,10) }</div>
            </div>
            <div class="clear"><br />
      ...
      <!--End 头部信息-->
         ...
         <tbody>
          ...
          <tr>
          	...
          	<td>
	            ...
	            <c:if test="${!empty session_user.nickName }"> ${session_user.nickName }</c:if>
          	</td>
          	<th>电子邮箱：</th>
          	<td>
        ...
        <div class="vipBasicInfoBox">
         <table cellpadding="0" cellspacing="0" class="basicTabIn">
          <tr><th>账户资金总额</th><td><font><fmt:formatNumber value="${user.userFundInfo.cashBalance+user.userFundInfo.frozenAmtN}" pattern="0.00"/></font>元</td></tr>
          <tr><th>可用金额</th><td><font><fmt:formatNumber value="${empty user.userFundInfo.cashBalance ? '0.00':user.userFundInfo.cashBalance}" pattern="0.00" /></font>元</td></tr>
          ...
          <tr><th>预计账户总收益</th><td><font><fmt:formatNumber value="${realMoney+dueRepay}" pattern="0.00"/></font>元</td></tr>
         </table>
         <table cellpadding="0" cellspacing="0" class="basicTabIn">
