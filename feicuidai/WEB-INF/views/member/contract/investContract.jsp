				...
				<div class="vipRightBox">
					<div class="vipHeadMenuBox">
						<ul>
							...
							<li><a href="<%=basePath%>member_index/investContract.htm"
								class="vipHeadLink">投资合同</a></li>						
						</ul>
					</div>
					<!--vipContBox-->
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>尊敬的翡翠贷用户，以下是您在翡翠贷的投资合同。
							</h1>
	                ...
	                <fmt:formatDate pattern="yyyy-MM-dd" value="${cur_date}" /></td>
										...
										<td><a href="/loaninfo/contact?loansignId=${loann.loanId }">合同下载</a></td>
									</tr>
									</c:forEach>
								</tbody>
								<tfoot>
