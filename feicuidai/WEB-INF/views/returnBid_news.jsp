...
<body>
	...
	<div id="wrapper">
		<div class="chengeOK">
			<span><img src="/resources/images/OK_icon.png" width="63"
				height="55" /> </span> <label>正在处理中</label>
		</div>
		<div>
			<input type="hidden" value="${orderId}" id="orderId" name="orderId" />
			<span id="sec">6</span> 秒后返回 <br /> <br /> <br />
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function lazyGo() {
			...
			if (sec > 0) {
				...
				top.window.location = "/return/ifAsynchronismBid.htm?orderId="
						+ orderId;
			}
		}
	</script>
