...
<div class="examine">
    ...
    <p>中国翡翠属于翡翠贷品牌合作方，为翡翠贷提供活动策划以及品牌宣传!</p></div>
    <div class="c"></div>
</div>
...
<div class="examine">
    ...
    <p>翡翠贷平台所有标的都托管于大师典藏馆，当借款人逾期无法偿还剩余借款时，平台将授权大师典藏馆将质押物回购，最大程度保障投资者收益！
</p></div>
    <div class="c"></div>
</div>
<!--</div>-->
...
$("#tem_content_3").css("display","block");
$(".div_span").children("span").css({"color":"#444444","border-bottom":"2px solid #9e9e9e"});

$(".right_span").children("span:first-child").css({"color":"#00bc00","border-bottom":"2px solid #00bc00"});
