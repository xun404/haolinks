...
function bindingBankCard() {
	var bankType = $("#bankType option:selected").text();
			...
			for ( var i in json_obj) {
				jQuery("#userbanklist").append(
						"<tr><td align='center'>"+json_obj[i].bankType+"</td><td align='center'>"
								...
								+ "</td><td align='center'><a href='javascript:deleteUserBank("+json_obj[i].id+");'>删除</a></td></tr>");
			}
			$("#addUserBank").css("display", "none");
			$("#verify_ips").css("display", "block");	
		} else {
...
function deleteUserBank(userbank_id){
